...
nnoremap <silent> <buffer> st :<C-u>call ficus#ficus#Sort('note', 'title')<CR>
nnoremap <silent> <buffer> sm :<C-u>call ficus#ficus#Sort('note', 'modified')<CR>
nnoremap <silent> <buffer> sc :<C-u>call ficus#ficus#Sort('note', 'created')<CR>
nnoremap <silent> <buffer> sr :<C-u>call ficus#ficus#SortReverse('note')<CR>
nnoremap <silent> <buffer> ss :<C-u>call ficus#ficus#SortTraverse('note', 0)<CR>
nnoremap <silent> <buffer> sS :<C-u>call ficus#ficus#SortTraverse('note', 1)<CR>
